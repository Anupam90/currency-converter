package com.example.anupam.curencyconverter;
...
public class MainActivity extends AppCompatActivity {
    ...
    public void convert(View view){
        ...
        Double poundAmouunt = dollarAmountDouble * 0.75;

        Toast.makeText(MainActivity.this, "in pound "+String.format("%.2f",poundAmouunt),Toast.LENGTH_SHORT).show();
